...
//			System.out.println("Spawning particle on "+(ctx.getServerHandler().playerEntity.worldObj.isRemote ? "client" : "server")+" side now!");
			ctx.getServerHandler().playerEntity.worldObj.spawnParticle(message.text, message.x, message.y, message.z, r, r1, r2);
