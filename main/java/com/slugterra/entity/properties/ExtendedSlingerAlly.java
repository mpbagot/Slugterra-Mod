...
public class ExtendedSlingerAlly implements IExtendedEntityProperties {
	...
	public ExtendedSlingerAlly(AllySlinger slinger){
		canLaunch = true;
		timeToFireAgain = 0;
	}

	public static final void register(AllySlinger slinger)
	{
		slinger.registerExtendedProperties(ExtendedSlingerAlly.EXT_PROP_NAME, new ExtendedSlingerAlly(slinger));
	}

	public static final ExtendedSlingerAlly get(AllySlinger slinger)
	{
		return (ExtendedSlingerAlly) slinger.getExtendedProperties(EXT_PROP_NAME);
	}
