...
public class EntityDirtUrchin extends EntitySlug{

	public EntityDirtUrchin(World p_i1738_1_) {
		super(p_i1738_1_);
		this.slugItem = SlugItemRegistry.dirturchin;
	}
	
	@Override
	public EntityAgeable createChild(EntityAgeable p_90011_1_) {
		return new EntityDirtUrchin(worldObj);
	}
}
