...
public class RenderRamstoneVel extends Render  implements IItemRenderer {

	ModelRamstoneVel slugmodel;
	ModelRamstone slugmodel2;
	private static final ResourceLocation infernusTexture = new ResourceLocation(Strings.MODID + ":textures/entity/ramstone.png");
	private static final ResourceLocation infernusvelTexture = new ResourceLocation(Strings.MODID + ":textures/entity/ramstonevel.png");
	...
	public RenderRamstoneVel(Item p_i1259_1_, int p_i1259_2_)
	{
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
	{
		...
		if (isProtoForm){
			...
			slugmodel2.render(null, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
		}
		else{
