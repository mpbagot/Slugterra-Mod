...
public class RenderMakoBreakerVel extends Render  implements IItemRenderer {

	ModelMakoBreakerVel slugmodel;
	private static final ResourceLocation infernusvelTexture = new ResourceLocation(Strings.MODID + ":textures/entity/makobreakervel.png");
	private static final ResourceLocation infernusTexture = new ResourceLocation(Strings.MODID + ":textures/entity/makobreaker.png");
