...
public class RenderArmasheltVel extends Render  implements IItemRenderer {

	ModelArmasheltVel slugmodel;
	private static final ResourceLocation infernusvelTexture = new ResourceLocation(Strings.MODID + ":textures/entity/armasheltvel.png");
	...
	public RenderArmasheltVel(Item p_i1259_1_, int p_i1259_2_)
	{
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
	{
		...
		if (p_76986_1_.ticksExisted < 5)
			Minecraft.getMinecraft().renderEngine.bindTexture(armasheltTexture);
		else
