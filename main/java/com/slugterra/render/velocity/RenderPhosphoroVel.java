...
public class RenderPhosphoroVel extends Render  implements IItemRenderer {
	...
	private static final ResourceLocation infernusvelTexture = new ResourceLocation(Strings.MODID + ":textures/entity/phosphorovel.png");
	private static final ResourceLocation infernusTexture = new ResourceLocation(Strings.MODID + ":textures/entity/phosphoro.png");
	private Item field_94151_a;
	private int field_94150_f;
	private static final String __OBFID = "CL_00001008";

	public RenderPhosphoroVel(Item p_i1259_1_, int p_i1259_2_)
	{
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		case EQUIPPED:
			...
			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Strings.MODID + ":textures/entity/phosphorovel.png"));
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
	{
		...
		slugmodel.render(null, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F, p_76986_1_.ticksExisted < 3);
