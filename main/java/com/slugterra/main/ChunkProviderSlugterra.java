...
public class ChunkProviderSlugterra implements IChunkProvider, IChunkGenerator
{
    ...
    public ChunkProviderSlugterra(World par1World, long par2)
    {
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        //TODO:put world generators here
        //int var4 = par2 * 16;
		//int var5 = par3 * 16;
        //new WorldGenSchematicNo0().generate(this.worldObj, rand, var4, 0, var5);


        doGen = TerrainGen.decorate(worldObj, hellRNG, k, l, net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.SHROOM);

        WorldGenMinable worldgenminable = new WorldGenMinable(SlugterraBlocks.mushroom, 13, Blocks.grass);
        int j2;
