...
public class WorldChunkManagerSlugterra extends WorldChunkManager
{
	...
	protected WorldChunkManagerSlugterra()
	{
	...
	public WorldChunkManagerSlugterra(long seed, WorldType worldtype)
	{
		this();
	...
	public WorldChunkManagerSlugterra(World world)
	{
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5) {
		...
		for (int i = 0; i < par4 * par5; ++i) {
			if (aint[i] >= 0) {
				...
				par1ArrayOfBiomeGenBase[i] = BiomeRegistry.bullseyeCavern;
			}
		}
