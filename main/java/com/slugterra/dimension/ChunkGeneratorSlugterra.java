...
public class ChunkGeneratorSlugterra implements IChunkProvider {
	...
	public ChunkGeneratorSlugterra(World world, long seed, boolean mapFeaturesEnabled)
	{
		this.worldObj = world;
	...
	public void replaceBlocksForBiome(int par1, int par2, Block[] blocks, byte[] par3ArrayOfByte, BiomeGenBase[] par4ArrayOfBiomeGenBase) {
		...
		for (int k = 0; k < 16; ++k) {
			for (int l = 0; l < 16; ++l) {
				SlugterraBiomes biomegenbase = (SlugterraBiomes) par4ArrayOfBiomeGenBase[l + k * 16];
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
		...
		//Generate the Bioluminescent Mushrooms
		if (rand.nextInt(4) == 1){
			(new WorldGenMushrooms()).generate(rand, k, l, this.worldObj, this, this);
		}
